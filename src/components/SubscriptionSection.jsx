...
const SubscriptionSection = () => {
    ...
    return (
        <div className="relative pt-28 pb-60 px-6 bg-[radial-gradient(circle,#00CAFF_6%,#0066FF_120%),url('../../public/background-cover2.png')] bg-cover bg-center bg-no-repeat bg-blend-multiply">
            ...
            <div className="mx-auto flex justify-center align-center gap-4">
                <div className=" border-none rounded-[18px] bg-white p-3 shadow-[0_4px_10px_rgba(0,0,0,0.25)]">
                    <div className="bg-[radial-gradient(circle,#00CAFF_5%,#0066FF_190%)] p-4 flex flex-col gap-6 rounded-[18px] mb-6">
                        <div className="flex justify-between items-center gap-8">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[12px] leading-[14.52px] text-white font-[500]">1 Year</span>
                                <button className="w-[22px] h-[22px] flex items-center justify-center rounded-full bg-white border border-none cursor-pointer shadow-md hover:bg-gray-100 active:scale-90 transition">
                                    <span className="text-md font-small text-[#0066FF]">+</span>
                                </button>
                            </div>
                        ...
                        <div>
                            <p className="text-white">
                                <span className="text-[36px] leading-[43.56px] font-[500]">₹499 Only </span>
                    ...
                    <button className="text-center w-[100%] h-[54px] cursor-pointer bg-[radial-gradient(circle,#00CAFF_4%,#0066FF_170%)] rounded-[100px] text-white uppercase text-[16px] font-[600] leading-[16.94px]">
                        Apply Now
                    </button>
                </div>
                <div className=" border-none rounded-[18px] bg-white p-3 shadow-[0_4px_10px_rgba(0,0,0,0.25)]">
                    <div className="bg-[radial-gradient(circle,#00CAFF_5%,#0066FF_190%)] p-4 flex flex-col gap-6 rounded-[18px] mb-6">
                        ...
                        <div>
                            <p className="text-white">
                                <span className="text-[36px] leading-[43.56px] font-[500]">₹999 Only </span>
