    ...
    >
      <div className="w-full max-w-[600px] mx-auto pointer-events-auto bg-white rounded-3xl shadow-[0_-6px_30px_rgba(13,27,76,0.15)] flex items-center justify-between gap-3 lg:gap-6 pl-4 pr-3 lg:pl-6 lg:pr-4 py-2 lg:py-2.5">
        ...
        <button
          ...
          className="poppins-font font-semibold shrink-0 flex items-center gap-2 text-white text-[13px] lg:text-[15px] rounded-full px-5 lg:px-7 py-2.5 lg:py-3 shadow-[0_8px_20px_rgba(46,158,63,0.35)] cursor-pointer transition-all hover:opacity-90 bg-[linear-gradient(90deg,#5FC24B,#2E9E3F)] whitespace-nowrap"
        >
          Start Free Trial
