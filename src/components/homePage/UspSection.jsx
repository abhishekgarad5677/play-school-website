...
const UspSection = () => {
  const data = [
    ...
    {
      img: card2,
      title: "7 Skill Based Learning",
      desc: "Activities Based on Word, Number, Music, Nature, People, Self and Art",
      gradient: "bg-[radial-gradient(circle,#00CAFF_6%,#0066FF_120%)]",
    },
    {
      img: card3,
      ...
      desc: "Available in 16 Indian and International Languages",
      gradient: "bg-[radial-gradient(circle,#FF5177_6%,#D4002F_120%)]",
    },
    {
      img: card4,
