...
const Step4 = ({ setStep }) => {
  ...
  return (
    <div className="relative h-screen mt-10 w-full sm:w-[92%] lg:w-[60%] p-4 sm:p-5 bg-white border-[3px] sm:border-4 rounded-[22px] sm:rounded-[32px] border-[#019CFF] scale-[0.90] sm:scale-100">
        ...
        <div className="w-[80%] mx-auto space-y-4">
          ...
          <div className="w-full border-2 border-[#1E7BEA] rounded-2xl px-4 sm:px-6 py-3 sm:py-4">
            ...
            <div className="mt-1 text-[12px] sm:text-[14px] lg:text-[16px] text-[#484848] font-semibold">
              ...
              <span className="line-through text-[#8B8B8B] mr-2">
                ...
                {Math.floor((planDetails?.price ?? 0) * 1.5)}
              </span>
          ...
          <div className="w-full max-w-[900px] grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            ...
            <div className="bg-[#F4F4F4] rounded-2xl py-3 sm:py-5 px-3 sm:px-4 gap-2 flex justify-start sm:justify-center items-center">
              ...
              <div className="text-[11px] sm:text-[12px] lg:text-[13px] text-[#5A5A5A] text-left">
                Progress tracking & telling me about what you have done? that's
                not needed at all. leaderboards
              </div>
            </div>
          </div>
